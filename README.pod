...
If the requested L<gantry action|/Gantry Actions> is s source-independent operation
...
L<C<WEB_SITE_AUTH_PUBLIC=yes|$doc/README_build.html#WEB_SITE_AUTH_EXTERNAL>
